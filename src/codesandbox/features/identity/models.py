...
class User(Model):
    ...
    auth_locked_until = DateTimeField(nullable=True)
    auth_failure_streak = IntegerField(default=0)
    last_login_ip = StringField(max_length=45, nullable=True)
    last_login_ua_hash = StringField(max_length=64, nullable=True)
