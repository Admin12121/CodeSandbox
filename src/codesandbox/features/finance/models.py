...
class Coupon(Model):
    ...
    value = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
...
class UsageCharge(Model):
    ...
    cost_hr_snapshot = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    gross_amount = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    discount_amount = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    credit_amount = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    final_amount = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    refunded_amount = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
...
class CouponRedemption(Model):
    ...
    redeemed_amount = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    currency = StringField(max_length=3, default="GBP")
    created_at = DateTimeField(default=_now)
    metadata_json = TextField(nullable=True)
...
class CreditGrant(Model):
    ...
    remaining_amount = DecimalField(max_digits=12, decimal_places=4)
    currency = StringField(max_length=3, default="GBP")
...
class Invoice(Model):
    ...
    subtotal = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    discount_total = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    credit_total = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    refund_total = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    total = DecimalField(max_digits=12, decimal_places=4, default=Decimal("0.00"))
    currency = StringField(max_length=3, default="GBP")
